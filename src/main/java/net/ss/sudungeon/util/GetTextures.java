...
public class GetTextures {
    ...
    public static ResourceLocation block (String filename) {
        return get("block", filename);
    }

    // ✅ Mới thêm: Lấy skin theo ID nhân vật
    public static ResourceLocation characterSkin(String id) {
        return switch (id) {
            case "alex" -> new ResourceLocation("ss", "textures/entity/player/wide/alex.png");
            case "steve" -> new ResourceLocation("ss", "textures/entity/player/wide/steve.png");
            default -> new ResourceLocation("minecraft", "textures/entity/steve.png");
        };
    }
