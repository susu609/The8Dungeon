...
public class TargetDummyModel<T extends Entity> extends ModHierarchicalModel<T> {
    ...
    public @NotNull ModelPart root () {
        return this.bone; // 'bone' là phần gốc của mô hình TargetDummyEntity
    }

    @Override
    public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        if (entity instanceof TargetDummyEntity targetDummy) {
