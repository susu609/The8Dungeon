...
public class ModZombieModel<T extends Entity> extends ModHierarchicalModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SsMod.MODID, "model_mod_zombie"), "main");
    ...
    public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        if (entity instanceof ModZombieEntity modzombie) {
            ...
            this.animate(modzombie.summonAnimationState, ModZombieAnimation.ZOMBIE_SPAWN2, ageInTicks);
