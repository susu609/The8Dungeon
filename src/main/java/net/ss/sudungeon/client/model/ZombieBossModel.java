...
public class ZombieBossModel<T extends Entity> extends ModHierarchicalModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SsMod.MODID, "model_zombie_boss"), "main");
    private final ModelPart bone;
    private final ModelPart body;
    private final ModelPart head;
    private final ModelPart head_wear;
    ...
    public void setupAnim(@NotNull T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        if (entity instanceof ZombieBossEntity zombieboss) {
            ...
            this.animate(zombieboss.attackAnimationState, ModZombieAnimation.ZOMBIE_ATTACK, ageInTicks);
            this.animate(zombieboss.hurtAnimationState, ModZombieAnimation.ZOMBIE_HURT, ageInTicks);
            this.animate(zombieboss.idleAnimationState, ModZombieAnimation.ZOMBIE_IDLE, ageInTicks);
            this.animate(zombieboss.slamAnimationState, ModZombieAnimation.ZOMBIE_GROUND_SLAM, ageInTicks);
            this.animate(zombieboss.slashAnimationState, ModZombieAnimation.ZOMBIE_WIDE_SLASH, ageInTicks);
